...
(function () {
  ...
  // Этапы работы — перенесены из прежнего сайта (подбор → проверка → торг → сделка).
  MR.DEAL_STEPS = [
    { n: "1", title: "Подбор", text: "Отбираю объекты под вашу задачу и бюджет." },
    { n: "2", title: "Проверка", text: "Проверяю юридическую чистоту ещё до показа." },
    { n: "3", title: "Торг", text: "Веду переговоры и договариваюсь о цене." },
    { n: "4", title: "Сделка", text: "Сопровождаю до передачи ключей." }
  ];
  ...
  MR.DEFAULT_CONFIG = {
    ...
    photo: "assets/img/marianna.jpg",
    role: "Риелтор-эксперт",
    region: "Геленджик и побережье",
    about: "Не просто показываю объекты — веду сделку целиком: подбор под задачу, юридическая проверка до показа, торг и сопровождение до передачи ключей.",
    credentials: "Работаю официально, как самозанятый. Документы проверены.",
